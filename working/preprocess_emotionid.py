...
# 1. Cấu hình
# =========================
DATA_DIR = "/Speech_Emotion_Recognition/input/ravdess-emotional-speech-audio"  # dataset gốc
OUTPUT_DIR = "/Speech_Emotion_Recognition/working/processed"  # thư mục lưu WAV + CSV
